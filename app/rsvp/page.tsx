...
import { Search, CheckCircle, AlertCircle, ChevronRight, ChevronLeft, X } from "lucide-react"
                    ...
                    <div>
                      ...
                      <div className="bg-jewel-sapphire/10 border border-jewel-sapphire/30 rounded-lg p-3 mb-4">
                        <p className="text-sm text-jewel-burgundy font-medium">
                          ⚠️ Important: You <strong>must select your name from the dropdown list</strong> below. Simply typing your name won't work - please click on your name when it appears!
                        </p>
                      </div>
                      <p className="text-charcoal/70 mb-4">
                        Type your name as it appears on your invitation, then <strong>click on your name</strong> from the list that appears.
                      </p>
                    </div>
                      ...
                      {selectedGuest && formData.guestName === selectedGuest.guest_name && (
                        <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded-lg">
                          <p className="text-sm text-green-700 flex items-center gap-2 font-medium">
                            ...
                            ✓ Perfect! Your name has been selected. Click "Next" to continue.
                          </p>
                        </div>
                      )}
                      ...
                      {!selectedGuest && formData.guestName.length >= 2 && autocompleteSuggestions.length === 0 && (
                        <div className="mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded-lg">
                          <p className="text-sm text-yellow-700">
                            No matches found. Please check your spelling or try a different variation of your name. If you can't find your name, please contact us directly.
                          </p>
                        </div>
                      )}
                    </div>
                ...
                {currentStep === 3 && (
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-charcoal/70 mb-4">
                        Let us know if you'll be joining us on February 13, 2026!
                      </p>
                    </div>
                ...
                {currentStep === 4 && (
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-charcoal/70 mb-4">
                        Tell us how many guests and any special requirements.
                      </p>
                    </div>
                    <div>
                    ...
                    <div className="bg-jewel-fuchsia/10 border border-jewel-fuchsia/30 rounded-lg p-3">
                      <p className="text-xs text-charcoal leading-relaxed">
                        <strong>Note about children:</strong> We'd love for you to enjoy the night child-free, but if you plan to bring children, please include their ages in the message above.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-soft-blush/50 rounded-lg p-4 space-y-3 border border-jewel-burgundy/20">
                      ...
                      <div>
                        ...
                        <p className="text-charcoal">{formData.attendance === "yes" ? "✅ Attending" : "❌ Not Attending"}</p>
                      </div>
                      <div>
              ...
              <div className="px-6 py-4 border-t border-jewel-burgundy/20 bg-jewel-burgundy/5 flex items-center justify-between gap-4">
                ...
                {currentStep < totalSteps ? (
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-jewel-burgundy hover:bg-jewel-crimson disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium"
                  >
